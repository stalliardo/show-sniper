    ...
    return (
        <div className='w-full bg_colour p-4 rounded'>
            <form className='flex items-center flex-col sm:flex-row' onSubmit={handleSubmit}>
                <input type='text' placeholder='Harry Potter etc' className='w-full sm:w-2/3  rounded p-2 bg-slate-900 sm:mr-20' value={searchText} onChange={(e) => setSearchText(e.target.value)}/>
